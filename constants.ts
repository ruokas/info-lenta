...
export const INITIAL_MEDICATIONS: MedicationItem[] = [
  { id: 'm1', name: 'Acetylcysteinum', dose: '600mg', route: 'PO', category: 'Kiti', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm2', name: 'Acidum acetylsalicylicum', dose: '100mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm3', name: 'Actilyse', dose: '50mg', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm4', name: 'Adenosinum', dose: '5mg/ml 2ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm5', name: 'Adrenalinum', dose: '1mg/ml 1ml', route: 'IV', category: 'Reanimaciniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm6', name: 'Aktyvioji anglis', dose: '2,88g', route: 'PO', category: 'Toksikologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm7', name: 'Aminofilinum', dose: '24mg/ml', route: 'IV', category: 'Kvėpavimo takams', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm8', name: 'Amiodaronum', dose: '50mg/ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm9', name: 'Amlodipinum', dose: '10mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm10', name: 'Amoxicillinum/Acidum Clavulanicum', dose: '1000/200mg', route: 'IV', category: 'Antibiotikai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm11', name: 'Antitoks.serumas muo gyvačių nuodų', dose: '1 amp', route: 'IV', category: 'Toksikologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm12', name: 'Apixabanum', dose: '2,5mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10, expirationDate: '2026-12-04' },
  { id: 'm13', name: 'Apixabanum', dose: '5mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm14', name: 'Atropini sulfas', dose: '1mg/ml 1ml', route: 'IV', category: 'Reanimaciniai', quantity: 100, minQuantity: 10 },
  { id: 'm15', name: 'Bisoprololum', dose: '5mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm16', name: 'Captoprilum', dose: '25mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm17', name: 'Captoprilum', dose: '50mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm18', name: 'Carbamazepinum', dose: '200mg', route: 'PO', category: 'Neurologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm19', name: 'Cefazolinum', dose: '1g', route: 'IV', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm20', name: 'Cefriaxonum', dose: '1g', route: 'IV', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm21', name: 'Cefuroximum', dose: '1500mg', route: 'IV', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm22', name: 'Ciprofloxacinum', dose: '500mg', route: 'PO', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm23', name: 'Clarithromycinum', dose: '500mg', route: 'PO', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm24', name: 'Clemastinum', dose: '1mg/ml', route: 'IV', category: 'Priešalerginiai', quantity: 100, minQuantity: 10 },
  { id: 'm25', name: 'Clopidogrelum', dose: '75mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm26', name: 'Dexamethasonum', dose: '4mg/ml', route: 'IV', category: 'Priešalerginiai', quantity: 100, minQuantity: 10 },
  { id: 'm27', name: 'Dicynone', dose: '250mg 2ml', route: 'IV', category: 'Kraujavimui', quantity: 100, minQuantity: 10 },
  { id: 'm28', name: 'Diclofenacum', dose: '75mg/3ml', route: 'IM', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm29', name: 'Drotaverinum', dose: '40mg/2ml', route: 'IV', category: 'Spazmolitikai', quantity: 100, minQuantity: 10 },
  { id: 'm30', name: 'Duphalac', dose: '500ml', route: 'PO', category: 'Virškinimo traktui', quantity: 100, minQuantity: 10 },
  { id: 'm31', name: 'Enaloprilum', dose: '1,25mg/ml 1ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm32', name: 'Esomeprazolum', dose: '40mg', route: 'IV', category: 'Virškinimo traktui', quantity: 100, minQuantity: 10 },
  { id: 'm33', name: 'Etomidatum', dose: '2mg/ml', route: 'IV', category: 'Sedacija', quantity: 100, minQuantity: 10 },
  { id: 'm34', name: 'Furosemidum', dose: '10mg/ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm35', name: 'Glyceroli trinitras', dose: '0,5mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm36', name: 'Glyceroli trinitras', dose: '1mg/ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm37', name: 'Heparinum', dose: '25000 IU/5ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm38', name: 'Hydrogenii peroxidi 3%', dose: '100ml', route: 'Topical', category: 'Kiti', quantity: 100, minQuantity: 10 },
  { id: 'm39', name: 'Ibuprofenum', dose: '400mg', route: 'PO', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm40', name: 'Imovax d.T adult', dose: '0.5ml', route: 'IM', category: 'Vakcinos', quantity: 100, minQuantity: 10 },
  { id: 'm41', name: 'Insulinum Humulin', dose: 'var', route: 'SC', category: 'Endokrinologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm42', name: 'Isosorbidum dinitrum', dose: '10mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm43', name: 'Kalii chloridum', dose: '750mg', route: 'PO', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm44', name: 'Ketoprofenum', dose: '100mg/2ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm45', name: 'Ketorolaci tromethaminum', dose: '30mg/ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm46', name: 'Loperamidum', dose: '2mg', route: 'PO', category: 'Virškinimo traktui', quantity: 100, minQuantity: 10 },
  { id: 'm47', name: 'Magnesium sulfatum', dose: '250mg/ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm48', name: 'Metamizolum sodium', dose: '500mg/ml 2ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm49', name: 'Metoclopramidum', dose: '5mg/ml 2ml', route: 'IV', category: 'Virškinimo traktui', quantity: 100, minQuantity: 10 },
  { id: 'm50', name: 'Metoprololum', dose: '1mg/ml 5ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm51', name: 'Metoprololum', dose: '25mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm52', name: 'Metoprololum', dose: '47,5mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm53', name: 'Microlax', dose: '5ml', route: 'PR', category: 'Virškinimo traktui', quantity: 100, minQuantity: 10 },
  { id: 'm54', name: 'Moxonidinum', dose: '0,4mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm55', name: 'Nadroparinum calcicum', dose: '2850 anti-Xa TV/0,3ml', route: 'SC', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm56', name: 'Nadroparinum calcicum', dose: '5700 anti-Xa TV/0,6ml', route: 'SC', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm57', name: 'Naloxonum', dose: '0,4mg/ml 1ml', route: 'IV', category: 'Reanimaciniai', quantity: 100, minQuantity: 10 },
  { id: 'm58', name: 'Norepinephrinum', dose: '1mg/ml 4ml', route: 'IV', category: 'Reanimaciniai', quantity: 100, minQuantity: 10 },
  { id: 'm59', name: 'NovoRapid FlexPen', dose: '100V/ml', route: 'SC', category: 'Endokrinologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm60', name: 'Ondansetronum', dose: '2mg/ml 4ml', route: 'IV', category: 'Virškinimo traktui', quantity: 100, minQuantity: 10 },
  { id: 'm61', name: 'Pantoprazolum', dose: '40mg', route: 'IV', category: 'Virškinimo traktui', quantity: 100, minQuantity: 10 },
  { id: 'm62', name: 'Paracetamolum', dose: '10mg/ml 100ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm63', name: 'Paracetamolum', dose: '500mg', route: 'PO', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm64', name: 'Penicilinum', dose: '1000000TV', route: 'IV', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm65', name: 'Pentoxifyllinum', dose: '20mg/ml 5ml', route: 'IV', category: 'Kiti', quantity: 100, minQuantity: 10 },
  { id: 'm66', name: 'Propofolum', dose: '10mg/ml 20ml', route: 'IV', category: 'Sedacija', quantity: 100, minQuantity: 10 },
  { id: 'm67', name: 'Ramiprilum', dose: '10mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm68', name: 'Rocuronium bromide', dose: '10mg/ml 5ml', route: 'IV', category: 'Reanimaciniai', quantity: 100, minQuantity: 10 },
  { id: 'm69', name: 'Salbutamolum', dose: '100mcg/doz.', route: 'Inhal', category: 'Kvėpavimo takams', quantity: 100, minQuantity: 10 },
  { id: 'm70', name: 'Salbutamolum', dose: '2,5mg/2,5ml', route: 'Nebul', category: 'Kvėpavimo takams', quantity: 100, minQuantity: 10 },
  { id: 'm71', name: 'Salbutamolum', dose: '500mcg/ml', route: 'IV', category: 'Kvėpavimo takams', quantity: 100, minQuantity: 10 },
  { id: 'm72', name: 'Thiaminum', dose: '50mg/ml 2ml', route: 'IV', category: 'Vitaminai', quantity: 100, minQuantity: 10 },
  { id: 'm73', name: 'Nifedipinum', dose: '20mg', route: 'PO', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm74', name: 'Piperacillinum/Tazobactamum', dose: '4/0,5g', route: 'IV', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm75', name: 'Midazolamum', dose: '5mg/ml 1ml', route: 'IV', category: 'Sedacija', quantity: 100, minQuantity: 10 },
  { id: 'm76', name: 'Tiapridum', dose: '100mg/2ml', route: 'IV', category: 'Neurologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm77', name: 'Diazepamum', dose: '5mg/ml 2ml', route: 'IV', category: 'Neurologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm78', name: 'Diazepamum', dose: '5mg', route: 'PO', category: 'Neurologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm79', name: 'Haloperidolum', dose: '5mg/ml 1ml', route: 'IV', category: 'Neurologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm80', name: 'Digoxinum', dose: '0,5mg/2ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm81', name: 'Flumazenilum', dose: '0,1mg/ml 5ml', route: 'IV', category: 'Reanimaciniai', quantity: 100, minQuantity: 10 },
  { id: 'm82', name: 'Calcium gluconatum', dose: '10% 10ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm83', name: 'Phytomenadionum', dose: '10mg/ml 1ml', route: 'IM', category: 'Vitaminai', quantity: 100, minQuantity: 10 },
  { id: 'm84', name: 'Tranexamic acid', dose: '100mg/ml 5ml', route: 'IV', category: 'Kraujavimui', quantity: 100, minQuantity: 10 },
  { id: 'm85', name: 'Ketaminum hydrochloridum', dose: '250mg/5ml', route: 'IV', category: 'Sedacija', quantity: 100, minQuantity: 10 },
  { id: 'm86', name: 'Labetalolum', dose: '5mg/ml 20ml', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm87', name: 'Glucose', dose: '40% 10ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm88', name: 'Natrio Nitroprusidas', dose: 'var', route: 'IV', category: 'Kardiologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm89', name: 'Ultracarbon', dose: '61,5/50g', route: 'PO', category: 'Toksikologiniai', quantity: 100, minQuantity: 10 },
  { id: 'm90', name: 'Morphinum', dose: '10mg/ml 1ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm91', name: 'Fentanylum', dose: '50mcg/ml 2ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm92', name: 'Tramadolum', dose: '50mg/ml 2ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm93', name: 'Pethidinum', dose: '50mg/ml 1ml', route: 'IV', category: 'Nuskausminamieji', quantity: 100, minQuantity: 10 },
  { id: 'm94', name: 'Mannitol Fresenius', dose: '10% 500ml', route: 'IV', category: 'Kiti', quantity: 100, minQuantity: 10 },
  { id: 'm95', name: 'Sodium Bicarbonate', dose: '8,4% 100ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm96', name: 'Sodium chloride', dose: '10% 100ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm97', name: 'Potassium chloride', dose: '10% 100ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm98', name: 'Metronidazolum', dose: '0.5% 100ml', route: 'IV', category: 'Antibiotikai', quantity: 100, minQuantity: 10 },
  { id: 'm99', name: 'Sodium chloride', dose: '0,9% 500ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm100', name: 'Ringeri', dose: '500ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm101', name: 'Ringeri', dose: '1000ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm102', name: 'Sodium chloride', dose: '0.9% 250ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm103', name: 'Glucose', dose: '20% 500ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm104', name: 'Glucose', dose: '10% 500ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm105', name: 'Glucose', dose: '5% 500ml', route: 'IV', category: 'Elektrolitai', quantity: 100, minQuantity: 10 },
  { id: 'm106', name: 'Etanolio tirpalas', dose: '70% 100ml', route: 'Topical', category: 'Toksikologiniai', quantity: 100, minQuantity: 10 },
];
